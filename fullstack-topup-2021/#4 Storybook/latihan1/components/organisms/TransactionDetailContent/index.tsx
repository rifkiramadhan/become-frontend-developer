                    ...
                    <section className="checkout mx-auto">
                        <div className="d-flex flex-row  align-items-center justify-content-between mb-30">
                            <div className="game-checkout d-flex flex-row align-items-center">
                                ...
                                <div>
                                    <p className="fw-bold text-xl color-palette-1 mb-10">Mobile Legends:<br />
                                        The New Battle 2021
                                    </p>
                        ...
                        <div className="purchase pt-30">
                            ...
                            <Row label="Your Game ID" value="masyoshizer" />
                            <Row label="Order ID" value="#GG01" />
                            <Row label="Item" value="250 Diamonds" />
                            <Row label="Price" value={42000000} />
                            <Row label="Tax 10%" value={42000000} />
                            <Row label="Total" value={42000000} className="color-pallete-4" />
                        </div>
